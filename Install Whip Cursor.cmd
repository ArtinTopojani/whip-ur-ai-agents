...
if errorlevel 1 (
  ...
  echo.
  echo After it builds, you can run Whip Cursor from this folder or the Desktop shortcut.
  echo.
...
echo After install, use "Run Whip Cursor.cmd" to start the app.
echo.
